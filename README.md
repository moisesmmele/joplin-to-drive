...
Ensure your project directory looks like this before running. The `docker-compose.yml` relies on these specific paths:
...
├── config/
│   └── rclone.conf       # Generated by helper script
├── scripts/
│   ├── joplin-cron       # Schedule definition
│   ├── joplin-export.sh
│   └── helper-script.sh
└── ...
```
